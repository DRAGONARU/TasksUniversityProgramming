...
class Printable(ABC):
    """Абстрактный класс для печати информации."""
    @abstractmethod
    def print_info(self):
        '''
        Абстрактный метод для печати информации
        :return:
        '''
        pass
...
class Book(Printable):
    ...
    def print_info(self):
        """
        Печатает информацию о книге. Реализует абстрактный метод `print_info` из класса `Printable`.
        :return:
        """
